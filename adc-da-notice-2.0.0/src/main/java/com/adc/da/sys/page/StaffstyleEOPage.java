...
/**
 * <b>功能：</b>TS_STAFFSTYLE StaffstyleEOPage<br>
...
public class StaffstyleEOPage extends BasePage {
    ...
    public String getTitleNameOperator() {
        return this.titleNameOperator;
    }

    public void setTitleNameOperator(String titleNameOperator) {
        this.titleNameOperator = titleNameOperator;
    }
